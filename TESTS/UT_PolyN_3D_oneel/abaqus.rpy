...
# Run by cnober on Wed Apr 17 11:02:05 2024
#
...
executeOnCaeStartup()
o2 = session.openOdb(name='UT_PolyN_3D.odb')
#: Model: C:/temp/TESTS/UT_PolyN_3D_oneel/UT_PolyN_3D.odb
...
#: Warning: The output database 'C:/temp/TESTS/UT_PolyN_3D_oneel/UT_PolyN_3D.odb' disk file has changed.
#: 
