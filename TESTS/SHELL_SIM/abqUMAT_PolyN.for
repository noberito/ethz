...
!C WRITE TO A FILE
       ...
       OPEN(80, FILE = 'C:\temp\TESTS\SHELL_SIM\output.txt')
    1 FORMAT(30F30.8)	
...
!C  DEPBAR=ZERO
	...
	!c WRITE(80,1)SIGMA, NTENS, YF, GYF
...
!C      ASSEMBLE XIMAT MATRIX AND Y-VECTOR
        DO K1=1,NTENS,1
	        ...
	        DO K2=K1,NTENS,1
				WRITE(80,1)K1, K2, HF, HPF, DEPBAR
...
!C  UPDATE DDSDDE
	...
	!C write(80,1)TIME, EPBAR, SIGMA(2),SIGMA(1), HF, YF, AA, BB, CC
    DEALLOCATE(KMATERIALX)
    DEALLOCATE(KMATERIALY)	
    RETURN
    END SUBROUTINE  UMAT
...
!C      COMPUTES THE HARDENING AND ITS DERIVATIVE
    ...
    IMPLICIT NONE
    INTEGER, PARAMETER :: PREC = 8
    REAL(PREC) :: HF, HPF, GG, EPBAR, AAZ, BBZ, CCZ, ONE
    ONE = 1.0D0
	GG = EXP(-CCZ*EPBAR)
    HF = BBZ * (ONE - GG)
	HPF = -CCZ * BBZ * GG
...
!CCCCCC************** 3) PLANE STRESS
	...
	REAL(PREC),PARAMETER::ZTOL=1.0E-003
	REAL(PREC)::BB
	INTEGER::JJ,KKO,MM
