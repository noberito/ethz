...
!CCCCCC************** 2) HOMOGENEITY DEGREE = N (any degree)
	...
	DEVIA(1) = SIGMA(1) - ONETHIRD * (SIGMA(1) + SIGMA(2) + SIGMA(3))
    DEVIA(2) = SIGMA(2) - ONETHIRD * (SIGMA(1) + SIGMA(2) + SIGMA(3))
    DEVIA(3) = SIGMA(4)
    DEVIA(4) = SIGMA(5)
    DEVIA(5) = SIGMA(6)
	...
	REAL(PREC),DIMENSION(NKMAT)::KMATERIAL
	REAL(PREC)::YF,ZYF,MAX, ONETHIRD, TWOTHIRD
    REAL(PREC)::ZTOL=1.0E-10
...
!CC***************************************************************************
	...
	REAL(PREC),DIMENSION(NKMAT)::KMATERIAL
	REAL(PREC)::YF, MAX, ONETHIRD, TWOTHIRD
    REAL(PREC)::ZTOL=1.0E-10
