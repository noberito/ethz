...
def simulate(test):
    ...
    run_sim_cmd = f'sbatch -n 24 -t 0-2 --mem-per-cpu=300 --tmp=300 --wrap "abaqus job=temp_{job} input={input_file} double interactive user={subroutine} cpus=24 scratch=\$TMPDIR"'
    sim_command = f"{abq} {run_sim_cmd}"
