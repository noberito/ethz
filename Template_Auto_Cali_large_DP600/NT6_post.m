...
widthOuter =str2num(cell2mat(A{1}(9))); 
...
%------------------------------------------------------- 
cd _results
savefig(1,'_NT6_Force_Disp_LocAxStrain_all')
saveas(1,['_NT6_Force_Disp_LocAxStrain_all.png'],'png');
savefig(2,'_NT6_Time_Displacement_all');
saveas(2,['_NT6_Time_Displacement_all.png'],'png');
% savefig(3,'_NT6_LocAxStrain_Displacement');
% saveas(3,['_NT6_LocAxStrain_Displacement.png'],'png');
cd ..
hold off
%%
%-------------------------------------------------------
...
ii=1;
for i=1:numel(listOf)
if (strncmp(listOf(i).name,'NT6_',4)==1)
filenames{ii}=listOf(i).name;
ii=ii+1;
end
end
...
geometry=  name(1:3);
orientation= name(5:6);
testnumber = name(8);
plotname = [geometry '-' orientation '-' testnumber];
testname = [geometry '_' orientation '_' testnumber];    
nameori = [geometry '_' orientation];
testnumber = str2num(name(8));
...
saveas(1,['NT6_Force_Disp_normalized.png'],'png')
