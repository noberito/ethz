...
% Eng Stress Strain 
%-----------------------------------
EngStrain_longi=u2./extenso_zone_2_3_u2;
EngStrain_width=u3./extenso_zone_5_6_u3;
EngStress=Force(1:length(u2)).*1000./(thickness.*outerwidth);
...
% Young's Modulus
%-----------------------------------
YoungExp(zz) = getYoungModulus(EngStrain_longi,EngStress) 
