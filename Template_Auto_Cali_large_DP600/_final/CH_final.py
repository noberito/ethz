...
session.XYDataFromHistory(name='SDV_EQPSdot', odb=odb, 
    outputVariableName='Equivalent Plastic Strain rate: SDV_EQPSdot at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='SDV_EQPS', odb=odb, 
    outputVariableName='Equivalent Plastic Strain: SDV_EQPS at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='SDV_Seq', odb=odb, 
    outputVariableName='Equivalent stress: SDV_Seq at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='SDV_LODE', odb=odb, 
    outputVariableName='Lode parameter: SDV_LODE at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='LEP1', odb=odb, 
    outputVariableName='Principal logarithmic strains: LEP1 at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='LEP2', odb=odb, 
    outputVariableName='Principal logarithmic strains: LEP2 at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='LEP3', odb=odb, 
    outputVariableName='Principal logarithmic strains: LEP3 at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='SP1', odb=odb, 
    outputVariableName='Principal stresses: SP1 at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='SP2', odb=odb, 
    outputVariableName='Principal stresses: SP2 at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='SP3', odb=odb, 
    outputVariableName='Principal stresses: SP3 at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='RF2', odb=odb, 
    outputVariableName='Reaction force: RF2 at Node 14364 in NSET BASE', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='RF2L', odb=odb, 
    outputVariableName='Reaction force: RF2 at Node 25791 in NSET LOAD', 
    steps=('Step-1', ), )
...
session.XYDataFromHistory(name='SDV_Svm', odb=odb, 
	outputVariableName='Mises equivalent stress: MISES at Element 11993 Int Point 1 in ELSET ONSET', 
	steps=('Step-1', ), )
session.XYDataFromHistory(name='SDV_T', odb=odb, 
    outputVariableName='Temperature: SDV_T at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='SDV_TRIAX', odb=odb, 
    outputVariableName='Triaxiality: SDV_TRIAX at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='SDV_D', odb=odb, 
    outputVariableName='Damage: SDV_D at Element 11993 Int Point 1 in ELSET ONSET', 
    steps=('Step-1', ), )
session.XYDataFromHistory(name='U2_EXT_X05_Y1', odb=odb, 
    outputVariableName='Spatial displacement: U2 at Node 12951 in NSET EXT_X05_Y1', 
    steps=('Step-1', ), )	
...
x20= session.xyDataObjects['U2_EXT_X05_Y1']
